CREATE TABLE `bilibili_rank_items` (
  ...
  `block_name` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '小类区名',
  `block_hot_time_range` varchar(5) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '排行时间范围',
  `order_num` int(11) NOT NULL COMMENT '排行序号',
  `href` varchar(255) NOT NULL COMMENT '链接',
  `title` varchar(255) NOT NULL COMMENT '标题',
  `point` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '综合评分',
...
CREATE TABLE `bilibili_ups_info` (
  ...
  `up_gz` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT 'up关注量',
...
CREATE TABLE `bilibili_videos_danmus` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=13767 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE `bilibili_videos_detail` (
  ...
  `up_name` varchar(255) NOT NULL COMMENT 'up名称',
  `up_desc` text COMMENT 'up简介',
  `up_gz` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT 'up被关注量',
  PRIMARY KEY (`id`)
...
CREATE TABLE `bilibili_videos_replys` (
  ...
  `crawl_time` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '爬取时间',
  `bv` varchar(50) NOT NULL COMMENT 'BV号',
  `context` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci COMMENT '评论内容',
  `time` varchar(50) NOT NULL COMMENT '评论时间',
  `like` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '评论点赞数',
  PRIMARY KEY (`id`)
